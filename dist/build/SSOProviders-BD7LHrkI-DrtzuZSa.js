import{u as d,j as e,Q as s,b6 as r,b7 as h,T as m,d as c,F as u}from"./strapi-BBvBqwE8.js";const g=({providers:t,displayAllProviders:a})=>{const{formatMessage:o}=d();return a?e.jsx(s.Root,{gap:4,children:t.map(n=>e.jsx(s.Item,{col:4,direction:"column",alignItems:"stretch",children:e.jsx(i,{provider:n})},n.uid))}):t.length>2&&!a?e.jsxs(s.Root,{gap:4,children:[t.slice(0,2).map(n=>e.jsx(s.Item,{col:4,direction:"column",alignItems:"stretch",children:e.jsx(i,{provider:n})},n.uid)),e.jsx(s.Item,{col:4,direction:"column",alignItems:"stretch",children:e.jsx(r,{label:o({id:"global.see-more"}),children:e.jsx(l,{as:h,to:"/auth/providers",children:e.jsx("span",{"aria-hidden":!0,children:"•••"})})})})]}):e.jsx(x,{justifyContent:"center",children:t.map(n=>e.jsx(i,{provider:n},n.uid))})},x=c(u)`
